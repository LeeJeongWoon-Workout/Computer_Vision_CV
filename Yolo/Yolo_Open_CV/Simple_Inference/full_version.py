...
(507, 85) (2028, 85) (8112, 85)   -> (13*13*3,5+80) , (26*26*3,5+80) , (52*52*3,5+85)  13X13 26X26 52X52 3은 Anchor Box 를 의미 그것을
2차원 array에 담기 위해 곱해준다. 85의 5는 중심좌표,너비,높이,Confident,80개의 COCO 클래스의 확률 결과적으로 총셀*3(anchorbox)의 사물함에 각각 85가지의 정보가 담겨 있다.
